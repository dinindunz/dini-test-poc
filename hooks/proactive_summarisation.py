...
from context_manager.summarisation_logger import SummarisationLogger
...
class ProactiveSummarisation(HookProvider):
    """
    ...
    - Proactive triggering for cost/performance optimisation
    """
    ...
    def __init__(
        ...
        """
        Initialise proactive summarisation hooks.
        ...
        # Initialise accurate token counter
